...
app.get('/api/admin/moderation', async (req, res) => {
  try {
    ...
    const rows = [
      ...posts.map(item => ({ ...item, itemType: 'post', displayTitle: item.title, owner: 'Lee Tech' })),
