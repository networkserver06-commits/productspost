(() => {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      .availability-controls{display:grid;gap:12px;margin-top:22px;padding-top:20px;border-top:1px solid #e5eaf1}.availability-heading h4{margin:0 0 4px;color:#12233f}.availability-controls label{display:grid;gap:7px;font-weight:700;font-size:13px}.availability-controls label input[type=checkbox]{margin-right:8px;accent-color:#1f5eff}.availability-controls textarea{min-height:64px;resize:vertical}      .maintenance-banner[hidden]{display:none!important}.maintenance-banner{display:flex;gap:10px;align-items:center;justify-content:center;padding:12px 18px;background:#fff4d6;color:#594400;border-bottom:1px solid #ead58c;font-size:14px}.maintenance-banner span{color:#6d5b26}.admin-health-message{margin-top:14px;padding:12px 14px;border-radius:12px;background:#f5f8ff;color:#5e6d84;font-size:13px;line-height:1.5}.negative{color:#b24859!important}.admin-summary-card b{overflow-wrap:anywhere}@media(max-width:700px){.maintenance-banner{display:block;text-align:center;font-size:12px}.maintenance-banner strong,.maintenance-banner span{display:block}.availability-controls{margin-top:18px}.availability-controls label{font-size:12px}}
  ...
  function renderAuth() {
    ...
    const signupPaused = register && window.leePublicConfig?.signupsRestricted === true;
